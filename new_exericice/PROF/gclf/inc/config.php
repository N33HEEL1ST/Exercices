...
$config = array(
	...
	'DB_database' => 'gclf',
	'OMDb_API_key' => '',
    'Base_URL' => '/27-mvc/gclf/public/' // obligatoire car on doit définir les URL en absolu
);

require dirname(__FILE__).DIRECTORY_SEPARATOR.'db.php';
require dirname(__FILE__).DIRECTORY_SEPARATOR.'functions.php';
$loader = require __APP_PATH__.DIRECTORY_SEPARATOR.'vendor'.DIRECTORY_SEPARATOR.'autoload.php';
$loader->addPsr4('Inc\\', dirname(__FILE__));
