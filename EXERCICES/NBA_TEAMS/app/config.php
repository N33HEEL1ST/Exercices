...
$w_config = [
    ...
    'db_name' => 'nbateams',								//nom de la bdd
	...
	'security_login_route_name' => 'users_signin',			//nom de la route affichant le formulaire de connexion

	// configuration globale
	'site_name'	=> 'NBA Teams', 								// contiendra le nom du site
];
