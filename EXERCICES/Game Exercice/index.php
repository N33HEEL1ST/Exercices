...
$game_nba_2K16 = new VideoGame(
    ...
    "E.A.", //$editor="",
    "Sports", //$genre="",
    VideoGame::CONSOLE_XBOX_ONE,  //$console=""
    50.99 //$price=0
);
echo "<pre>" ;
...
// exo 5
echo "<br />";
echo json_encode($game_nba_2K16, JSON_PRETTY_PRINT);

// exo 6
    // utiliser la methode abstract du VideoGame
VideoGame::letStart($game_nba_2K16);
